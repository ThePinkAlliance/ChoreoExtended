...
public class ChoreoTrajectoryState implements Interpolatable<ChoreoTrajectoryState> {
     ...
     *
     * @param timestamp       The timestamp of this state, relative to the beginning
     *                        of the trajectory.
     * @param x               The X position of the state in meters.
     * @param y               The Y position of the state in meters.
     * @param heading         The heading of the state in radians, with 0 being in
     *                        the +X direction.
     ...
     * @param t        the timestamp of the interpolated state. It should be between
     *                 this state and endValue.
    ...
    /**
     * Returns this state as a double array: {timestamp, x, y, heading, velocityX,
     * velocityY,
     * angularVelocity}.
     *
     * @return This state as a double array: {timestamp, x, y, heading, velocityX,
     *         velocityY,
     *         angularVelocity}.
     */
